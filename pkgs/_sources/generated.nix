...
{ fetchgit, fetchurl, fetchFromGitHub }:
{
  bspwm-rounded-corners = {
    pname = "bspwm-rounded-corners";
    version = "00e85df0505d2bfbd41234d1daf2f03c461b6a2b";
    src = fetchFromGitHub ({
      owner = "j-james";
      repo = "bspwm-rounded-corners";
      rev = "00e85df0505d2bfbd41234d1daf2f03c461b6a2b";
      fetchSubmodules = false;
      sha256 = "sha256-Bw2Cju5bcFnHUSc4C85mc9Kyg2pt+X3H1bwQQKokszY=";
    });
  };
  picom-arian8j2-git = {
  ...
  tokyo-night-gtk-theme = {
    ...
    version = "6bbb8954b62cd6fb696f7811e7e8049f89c51393";
    src = fetchFromGitHub ({
      owner = "Fausto-Korpsvart";
      repo = "Tokyo-Night-GTK-Theme";
      rev = "6bbb8954b62cd6fb696f7811e7e8049f89c51393";
      fetchSubmodules = false;
      sha256 = "sha256-5dkkfCS9d9detnTn86WcCUQCgDFJ9NI/tyHg8jqxKOI=";
    });
  };
  x11-emoji-picker = {
